...
preview:!0,dropZone:!0,maxNumberOfFiles:"",responseValidation:!1,maxFileSize:2,ajaxOptions:{},onUpload:function(){},onEachUpload:function(){},beforeUpload:function(){},beforeEachUpload:function(){},allowed:"",errorHandler:{method:function(a){alert(a)},success:"success",error:"error"}},a);c.allowed=c.allowed||["jpg","jpeg","png","bmp","gif"];return this.each(function(){var a=f(this);if(a.is('input[type="file"]')){if(!a.data("ssi_upload")){var b=new k(this,c);a.data("ssi_upload",b)}}else console.log("The targeted element is not file input.")})};
...
someErrorsOccurred:"\u03a3\u03b7\u03bc\u03b5\u03b9\u03ce\u03b8\u03b7\u03ba\u03b1\u03bd \u03bf\u03c1\u03b9\u03c3\u03bc\u03ad\u03bd\u03b1 \u03bb\u03ac\u03b8\u03b7!"},fr:{success:"Succ\u00e8s",sucUpload:"Envoi r\u00e9ussi",chooseFiles:"Choisissez fichiers",uploadFailed:"Envoi \u00e9chou\u00e9",serverError:"Erreur interne du serveur",error:"Erreur",abort:"Annuler",aborted:"Annul\u00e9",files:"Fichiers",upload:"Envoyer",clear:"Effacer",drag:"Glisser d\u00e9poser",sizeError:"$1 exc\u00e8de la taille limite de $2",
extError:"Types de fichier $1 non autoris\u00e9",someErrorsOccurred:"Une erreur a eu lieu !"}}});
